...
public class GameController: MonoBehaviour {
	...
	void Start () {
		...
		*/
		...
		ct.flavorText = "Syksy on jo pitk‰ll‰ ja pienen karhunpojan olisi aika p‰‰st‰ pes‰‰n talviunille. Karhunpoika ei kuitenkaan tied‰ reitti‰, vaan tarvitsee apuanne sen selvitt‰miseen. Auttakaa karhu pes‰‰n suorittaen matkan varrella vastaan tulevia teht‰vi‰.	";
		ct.taskText = "N‰p‰yt‰ keskiruutua tai teksti-ikkunaa sulkeaksi t‰m‰n teksti-ikkunan, ja  n‰p‰yt‰ pussia lis‰t‰ksesi uuden laatan.";
	...
	public bool addSnow(){
		...
		ct.flavorText = "Lumen m‰‰r‰ on kasvanut";
		ct.taskText = "";
		animateText ();
		return end;
	}
